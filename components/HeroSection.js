...
function HeroSection() {
  return (
    <div className="relative   h-[1028px]   ">
      ...
      <div className="flex h-[calc(1028px-200px)] flex-col md:flex-row max-w-[1920px]  mx-auto">
        <LeftText />
        <RightImage />
      </div>
    </div>
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center  ">
      <div className="w-[544px]">
        <h1 className="mb-4 text-7xl font-bold leading-tight text-[#2E3B4E]  ">
